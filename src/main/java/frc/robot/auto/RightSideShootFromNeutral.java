 ...
 */
public class RightSideShootFromNeutral extends SequentialCommandGroup {
    ...
    public static final AutoSupplier getAutoSupplier(
        ...
        return new AutoSupplier(
                () -> new RightSideShootFromNeutral(driveSubsystem, ballSubsystem, shooterSubsystem),
                BLUE_POSE);
    }

    private RightSideShootFromNeutral(
            final CANDriveSubsystem driveSubsystem,
            final CANFuelSubsystem ballSubsystem,
            final CANShooter shooterSubsystem) {
