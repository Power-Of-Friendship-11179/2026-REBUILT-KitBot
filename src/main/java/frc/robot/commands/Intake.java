...
public class Intake extends Command {
  ...
  CANShooter shooterSubsytem;

  public Intake(CANFuelSubsystem fuelSystem, CANShooter shooterSubsystem) {
    addRequirements(fuelSystem, shooterSubsystem);
